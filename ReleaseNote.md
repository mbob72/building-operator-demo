...
- Текущий этап: **этап 4 реализован и ожидает приёмки**.
- Этапы 0, 1, 2 и 3 завершены и приняты; этап 0 опубликован.
...
### Этап 4. Floor mode и building overview — реализован, ожидает приёмки
...
Реализованы восемь floor scenes, floor/building режимы, полный обзор 18 000 устройств, раздельный deterministic status snapshot, search/type/protocol/status filters, GPU picking и device/label LOD. Полный отчёт: `reports/stage-four.md`.
...
- Из архитектурного IFC подготовлены восемь этажей и 3 680 объектов плана с LOD metadata.
...
| Проверка | Результат |
|---|---|
| Восемь floor scenes и LOD invariants | Пройдена, 3 680 объектов |
