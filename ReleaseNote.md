...
- Текущий этап: **этап 5 реализован и ожидает приёмки**.
- Этапы 0–4 завершены и приняты; этап 5 не считается принятым до явного апрува пользователя; этап 0 опубликован.
